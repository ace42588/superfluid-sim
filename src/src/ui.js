...
export default class UI {
  constructor(ctx) {
    ...
    var gui = new dat.GUI({
      width: window.innerWidth < 600 ? window.innerWidth : 320,
      autoPlace: false,
    });
    ...
    gui
      .add(this.ctx.opts, "preset", [
        "Box",
        "Trapped & Rotating",
        "Random Vortices (Phase)",
        "Double Slit",
      ])
      ...
      .onChange(
        function (value) {
          if (value == "Box") {
            ...
            gl.uniform1i(
              gl.getUniformLocation(prog_step, "randVort"),
    ...
    gui
      .add(this.ctx.opts, "boundary", ["Periodic", "Reflective"])
      .name("Boundary Condition")
      .onChange(this.ctx.changeBoundary.bind(this.ctx));

    gui
      .add(this.ctx.opts, "gamma", 0.0, 0.3)
      .step(0.01)
      .name("Dissipation")
    ...
    gui
      .add(this.ctx.opts.addPot, "r", 0, 30)
      .step(0.1)
    ...
    gui
      .add(this.ctx.opts.addSlits, "active")
      .name("Enable Double Slit")
      .onChange(function (value) {
        gl.useProgram(prog_rk4);
    ...
    gui
      .add(this.ctx.opts.addSlits, "w", 0, 0.5)
      .step(0.01)
      .name("Slit Width")
      .onChange(function (value) {
        gl.useProgram(prog_rk4);
    ...
    gui
      .add(this.ctx.opts.addSlits, "s", 0, 0.5)
      .step(0.01)
      .name("Slit Spacing")
      .onChange(function (value) {
        gl.useProgram(prog_rk4);
    ...
    gui
      .add(this.ctx.opts.addVortex, "angular_momentum", -10, 10)
      .step(0.1)
      .name("Vortex AngMom");

    gui
      .add(this.ctx.opts.vortexPair, "x", 0.01, 1)
      .step(0.01)
      .name("Cannon Spacing");

    gui
      .add(this.ctx.opts.vortexPair, "delay", 100, 500)
      .step(10)
      .name("Cannon Delay");
